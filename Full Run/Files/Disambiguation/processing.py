...
def col_for_disamb(df, cd_id, cen_id, cd_fn="CD_F_FIRST_NAME", cen_fn="CENSUS_FIRST_NAME", cd_ln="CD_F_LAST_NAME",
...
"""
def apply_confidence_score(df, cd_fn = "CD_F_FIRST_NAME", cen_fn = "CENSUS_FIRST_NAME", cd_ln = "CD_F_LAST_NAME", cen_ln = "CENSUS_LAST_NAME", cen_occ = "CENSUS_OCCLABELB", cen_age = "CENSUS_AGE", cd_id="OBJECTID", cen_id="OBJECTID.x"):
