...
def get_matches(args):
    ...
    with open("../data/es-census-1880-1-12-2020","w+") as fw, open("../data/es-census-1880-1-12-2020-unmatch","w+") as fw2:
        fw.write(col+"\n")
        for idx, row in df.iterrows():
            ...
            # query = { "bool": { "must": [ { "match": { "CENSUS_NAMEFRSTB": "John" } }, { "match": { "CENSUS_NAMELASTB": "Robinson" } }, { "match": { "WARD_NUM": 10 } }, { "match": { "CENSUS_ED": 192 } }, { "terms": { "METAPHONE_NAMEFIRST.keyword": [ "JN", "AN" ] } }, { "terms": { "METAPHONE_NAMELAST.keyword": ["RPNSN"] } } ] } } 
            try:
